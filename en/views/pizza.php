  ...
  <div class="o-container">
    <div class="o-section">
	 ...
	 <div id="tabs" class="tabs">
				<nav>
					<ul>
						<li><a href="#section-1" class="icon-food"><span>Vegetarian Pizza</span></a></li>
						<li><a href="#section-2" class="icon-food"><span>Meats&chicken Pizza</span></a></li>
						<li><a href="#section-3" class="icon-food"><span>SeaFood Pizza</span></a></li>
     ...
     ?>
						<div class="mediabox">
							...
							<h3><?php echo $item["pizza_name_en"]; ?></h3>
							<p><?php echo $item["pizza_description_en"]; ?></p>
...
<?php
     ...
     ?>
						<div class="mediabox">
							<img src="assets/img/menu/1.jpg" alt="img01" />
								  <h3><?php echo $itemb["pizza_name_en"]; ?></h3>
								  <p><?php echo $itemb["pizza_description_en"]; ?> </p>
...
<?php
     ...
     ?>
						<div class="mediabox">
							<img src="assets/img/menu/1.jpg" alt="img01" />
								  <h3><?php echo $itemc["pizza_name_en"]; ?> </h3>
								  <p><?php echo $itemc["pizza_description_en"]; ?> </p>
     ...
     ?>
						<div class="mediabox">
							<img src="assets/img/menu/2.jpg" alt="img01" />
								  <h3><?php echo $itemchef["pizza_name_en"]; ?> </h3>
								  <p><?php echo $itemchef["pizza_description_en"]; ?> </p>
