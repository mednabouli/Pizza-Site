    ...
    <div class="o-section">
				...
				<nav>
					<ul>
						...
						<li><a href="#section-4" class="icon-food"><span>Salad</span></a></li>
     ...
     ?>
						<div class="mediabox">
							...
							<h3><?php echo $item["manakish_name_en"]; ?></h3>
							<p><?php echo $item["manakish_description_en"]; ?></p>
   ...
   endforeach; ?>
     ...
     ?>
						<div class="mediabox">
							...
							<h3><?php echo $itemb["sambousa_name_en"]; ?></h3>
							<p><?php echo $itemb["sambousa_description_en"]; ?></p>
     ...
     ?>
						<div class="mediabox">
							<img src="assets/img/menu/5.jpg" alt="img01" />
								<h3><?php echo $itemd["cheesy_name_en"]; ?> </h3>
								  <p><?php echo $itemd["cheesy_description_en"]; ?> </p>
     ...
     ?>
						<div class="mediabox">
							<img src="assets/img/menu/6.jpg" alt="img01" />
								<h3><?php echo $itemsl["salade_name_en"]; ?> </h3>
								  <p><?php echo $itemsl["salade_description_en"]; ?> </p>
     ...
     ?>
						<div class="mediabox">
							<img src="assets/img/menu/7.jpg" alt="img01" />
								<h3><?php echo $iteme["dessert_name_en"]; ?> </h3>
								  <p><?php echo $iteme["dessert_description_en"]; ?> </p>
     ...
     ?>
						<div class="mediabox">
							<img src="assets/img/menu/8.jpg" alt="img01" />
								  <h3><?php echo $itemc["acote_name_en"]; ?> </h3>
								  <p><?php echo $itemc["acote_description_en"]; ?> </p>
